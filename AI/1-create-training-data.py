...
def create_training_data():
    for category in CATEGORIES: # iterate through each breed we have pictures for
        path = os.path.join( DATADIR, category ) # gets into the path to the breed's pictures
        class_num = CATEGORIES.index(category) # Need to map each breed name to a number
